  ...
  return (
    <div className='grid grid-rows-3 h-screen'>
      <div className='grid grid-cols-2'>
        <div className='text-white text-4xl text-opacity-80 font-mono m-12 w-7/12 h-3/4 border-l-4 border-t-4 border-blue-400 relative p-10'>
          @AyLolo
        </div>
      ...
      <div className="ml-40 relative">
        ...
        <p className="text-white w-7/12 p-4 border-yellow-400 border-l-2">
        ...
        <img className="absolute top-px right-px  w-1/4 mr-40 rounded-lg" alt="Anthony Lopez" src={Me}/> 
      </div>
      <div className='grid grid-cols-3 w-screen pt-20'>
        <div className='text-white text-4xl text-opacity-80 font-mono text-center pt-20 ml-60'>
          Projects
        </div>
